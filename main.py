      ...
      while location <= 1000:
        ...
        if location <= 25:
          for x in range(100):
            ...
            print("ÿØÿà JFIF  H H  ÿá Exif  MM *           1      V2      t‡i      ˆê      J    ê         - 2 7 ; @ E J O T Y ^ c h m r w |  † ‹  • š Ÿ ¤ © ® ² · ¼ Á Æ Ë Ð Õ Û à å ë ð ö û%+28>ELRY`gnu|ƒ‹’š¡©±¹ÁÉÑÙáéòú&/8AKT]gqz„Ž˜¢¬¶ÁËÕàëõ !-8COZfr~Š–¢®ºÇÓàìù -;HUcq~Œš¨¶ÄÓáðþ+:IXgw†–¦µÅÕåö7HYj{Œ¯ÀÑãõ+=Oat†™¬¿Òåø2FZn‚–ª¾Òçû		%	:	O	d	y		¤	º	Ï	å	û")
          exit()
   print("You have entered an incorrect username or password. Please try again. " + str(attempts) + " attempts remain.")
   print("")
  else:
    loggedOut = False
